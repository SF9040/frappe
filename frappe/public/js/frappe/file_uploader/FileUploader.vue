			...
			<div v-if="!is_dragging">
				...
				<div class="mt-2 text-center">
					<button class="btn btn-file-upload" @click="browse_files">
						<div class="material-symbols-outlined" style="font-size: xxx-large;">laptop_mac</div>
					...
					>
						<div class="material-symbols-outlined" style="font-size: xxx-large;">cloud</div>
					...
					>
						<div class="material-symbols-outlined" style="font-size: xxx-large;">link</div>
					...
					<button
						...
						@click="capture_image"
					>
						<div class="material-symbols-outlined" style="font-size: xxx-large;">photo_camera</div>
					...
					>
						<div class="material-symbols-outlined" style="font-size: xxx-large;">cloud_sync</div>
